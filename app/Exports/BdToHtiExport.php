...
class BdToHtiExport implements FromView, WithEvents
{
    protected $data;
    ...
    {
        return view('reports.exports.bd-to-hti', [
    ...
    public function registerEvents(): array
	{
        return [
            AfterSheet::class    => function(AfterSheet $event) {
	            ...
	            $event->sheet->getStyle('Q3:AC1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AE3:AE1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AG3:AH1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AK3:AP1000')->getNumberFormat()->setFormatCode('#,##0_-');
