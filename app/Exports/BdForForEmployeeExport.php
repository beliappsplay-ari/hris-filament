...
class BdForForEmployeeExport implements FromView, WithEvents
{
    protected $data;
    ...
    {
        return view('reports.exports.bd-for-employee', [
    ...
    public function registerEvents(): array
	{
        return [
            AfterSheet::class    => function(AfterSheet $event) {
	            ...
	            $event->sheet->getStyle('I3:J1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('R3:S1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('X3:Y1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AA3:AC1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AG3:AG1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AP3:AP1000')->getNumberFormat()->setFormatCode('#,##0_-');
	            $event->sheet->getStyle('AR3:AR1000')->getNumberFormat()->setFormatCode('#,##0_-');
