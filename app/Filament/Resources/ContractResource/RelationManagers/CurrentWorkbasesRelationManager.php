...
class CurrentWorkbasesRelationManager extends RelationManager
{
    protected static string $relationship = 'currentWorkbases';
    ...
    public function table(Table $table): Table
    {
        return $table
            ->paginated(false)
            ->recordTitleAttribute('current_workbase')
            ->defaultSort('effective_date', 'desc')
            ->columns([
                TextColumn::make('current_workbase')
                    ->label('New Current Workbase'),
                TextColumn::make('old_current_workbase'),
