    ...
    <div class="rounded-t mb-0 px-4 py-3 border-0">
        <div class="flex flex-wrap items-center">
            <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                <h3 class="font-semibold text-base text-blueGray-700">Homebase Histories</h3>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td
                        ...
                        {{ \App\Models\Homebase::find($homebase->pivot->old_homebase)->name }}
                    </td>
                    <td
                        class="border-t-0 px-6 align-middle border border-solid border-blueGray-100 text-xs whitespace-nowrap p-4">
                        <i class="fas fa-arrow-up text-emerald-500 mr-4"></i>
                        {{ $homebase->pivot->reason }}
                    </td>
                    <td
                        class="border-t-0 px-6 align-middle border border-solid border-blueGray-100 text-xs whitespace-nowrap p-4">
                        <i class="fas fa-arrow-up text-emerald-500 mr-4"></i>
                        {{ $homebase->pivot->ref_date }}
                    </td>
                    <td
                        class="border-t-0 px-6 align-middle border border-solid border-blueGray-100 text-xs whitespace-nowrap p-4">
                        <i class="fas fa-arrow-up text-emerald-500 mr-4"></i>
                        {{ $homebase->pivot->remark }}
                    </td>
                    <td
                        class="border-t-0 px-6 align-middle border border-solid border-blueGray-100 text-xs whitespace-nowrap p-4">
                        <i class="fas fa-arrow-up text-emerald-500 mr-4"></i>
                        {{ $homebase->pivot->ref_no }}
                    </td>
                    <td
                        class="border-t-0 px-6 align-middle border border-solid border-blueGray-100 text-xs whitespace-nowrap p-4">
                        <i class="fas fa-arrow-up text-emerald-500 mr-4"></i>
                        <a href="{{ route('filament.admin.resources.homebase-histories.edit',$homebase) }}" class="underline hover:decoration-pink-500">Edit</a>
